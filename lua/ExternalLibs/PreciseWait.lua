...
--[[
    ...
    - Total Initialization:     https://github.com/BribeFromTheHive/Lua/blob/master/Total Initialization.lua
    - Global Variable Remapper: https://github.com/BribeFromTheHive/Lua/blob/master/Global Variable Remapper.lua
...
if OnInit then
    --Get OnInit at: https://github.com/BribeFromTheHive/Lua/blob/master/Total Initialization.lua
